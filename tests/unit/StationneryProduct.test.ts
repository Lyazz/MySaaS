...
import StationneryProduct from '../../components/storefront/templates/stationnery/Product.vue'
import ProductOrderForm from '../../components/storefront/templates/stationnery/partials/ProductOrderForm.vue'
import ProductDetails from '../../components/storefront/templates/stationnery/partials/ProductDetails.vue'
import ProductGallery from '../../components/storefront/templates/stationnery/partials/ProductGallery.vue'
import { createTestingPinia } from '@pinia/testing'
import { useState } from '#imports'

describe('StationneryProduct', () => {
    const mockProduct = {
        id: 'prod_123',
        title: 'Test Product',
        slug: 'test-product',
    ...
    it('renders product structure with correct child components', () => {
        const wrapper = mount(StationneryProduct, {
            props: {
                product: mockProduct
            },
            global: {
