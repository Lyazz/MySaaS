...
import aiDocumentsRouter from './modules/ai-documents/routes';
...
import superAdminAiRouter from './modules/superadmin/ai/routes';
...
router.use('/admin/ai-documents', aiDocumentsRouter);
...
router.use('/super-admin/ai', superAdminAiRouter);
