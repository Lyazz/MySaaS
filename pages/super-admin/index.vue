  ...
  <NuxtLayout name="super-admin">
    <div class="space-y-6">
      ...
      <div class="bg-gradient-to-br from-purple-900/50 to-pink-900/50 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6">
        <h2 class="text-xl font-semibold text-white mb-4">Platform Revenue</h2>
      ...
      <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6">
        <div class="flex justify-between items-center mb-4">
          ...
          <NuxtLink to="/super-admin/audit-logs" class="text-purple-400 hover:text-purple-300 transition-colors">
            View All →
          </NuxtLink>
        </div>
        
        <div v-if="loading" class="text-gray-400 text-center py-4">Loading...</div>
        <div v-else-if="recentLogs.length === 0" class="text-gray-400 text-center py-4">No recent activity</div>
        <div v-else class="space-y-3">
          ...
          >
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-gray-400 text-sm truncate">{{ log.details }}</p>
      ...
      <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <NuxtLink to="/super-admin/tenants" 
            ...
            <div class="flex items-center space-x-3">
              <div class="w-12 h-12 bg-purple-500/30 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-purple-300" viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clip-rule="evenodd" />
                </svg>
              </div>
              <div>
                <p class="text-white font-medium">Create Tenant</p>
                <p class="text-gray-400 text-sm">Add a new tenant</p>
              </div>
            </div>
          </NuxtLink>
          ...
          <NuxtLink to="/super-admin/tenants" 
            ...
            <div class="flex items-center space-x-3">
              ...
              <div>
                <p class="text-white font-medium">Manage Tenants</p>
                <p class="text-gray-400 text-sm">View all tenants</p>
              </div>
            </div>
          </NuxtLink>

          <NuxtLink to="/super-admin/analytics" 
            ...
            <div class="flex items-center space-x-3">
              ...
              <div>
                <p class="text-white font-medium">View Analytics</p>
