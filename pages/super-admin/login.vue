  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        ...
        <h1 class="text-3xl font-bold text-white mb-2">Super Admin Login</h1>
        <p class="text-gray-400">Sign in to access the platform dashboard</p>
      </div>
      ...
      <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8">
        ...
        <div class="mt-6 pt-6 border-t border-slate-700 text-center">
          <NuxtLink to="/" class="text-sm text-purple-400 hover:text-purple-300 transition-colors">
            ← Back to main site
          </NuxtLink>
        </div>
      </div>
