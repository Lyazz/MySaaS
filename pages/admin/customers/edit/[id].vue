<template>
  <div class="max-w-7xl mx-auto">
    ...
    <nav class="flex mb-6" aria-label="Breadcrumb">
      <ol class="inline-flex items-center space-x-1 md:space-x-3 rtl:space-x-reverse">
        <li class="inline-flex items-center">
          <NuxtLink to="/admin/customers" class="hover:[color:var(--brand)] text-secondary">
        ...
        <li>
          <div class="flex items-center">
            ...
            <NuxtLink :to="`/admin/customers/${customerId}`" class="ml-1 hover:[color:var(--brand)] text-secondary">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            <Icon name="lucide:chevron-right" class="w-6 h-6 text-tertiary" />
            <span class="ms-1 text-tertiary">{{ t('admin.pages.customers.edit.breadcrumb') }}</span>
          </div>
        </li>
      </ol>
    </nav>
    ...
    <div class="mb-6 flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
      <div>
        <h2 class="text-2xl font-bold text-primary">{{ t('admin.pages.customers.edit.title') }}</h2>
        <p class="mt-1 text-secondary">{{ t('admin.pages.customers.edit.subtitle') }}</p>
      </div>
...
>
    ...
    <div v-if="loading" class="ui-card p-12 text-center">
      ...
      <p class="mt-2 text-secondary">{{ t('admin.pages.customers.edit.loading') }}</p>
    </div>
