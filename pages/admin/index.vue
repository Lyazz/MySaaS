<template>
    <div class="max-w-7xl mx-auto">
      <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">Here's what's happening with your store</p>
      </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-gray-800 mt-1">{{ stats.productsCount }}</p>
            </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-gray-800 mt-1">{{ stats.categoriesCount }}</p>
            </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-gray-800 mt-1">{{ stats.ordersCount }}</p>
            </div>
      ...
      <div class="bg-white p-6 rounded-lg shadow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <div class="ml-4">
              <p class="font-medium text-gray-800">Add New Product</p>
          ...
          >
            ...
            <div class="ml-4">
              ...
              <p class="text-sm text-gray-600">Organize your products</p>
            </div>
          </NuxtLink>
        </div>
      </div>
