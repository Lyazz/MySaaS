...
const templates = computed(() => [
  ...
  { key: 'modern', label: 'Modern', category: 'Minimalist', storeTypes: t('admin.appearanceSettingsForm.templates.options.modern.storeTypes'), fontName: 'Outfit', fontStyle: "'Outfit', system-ui, sans-serif", color: '#65A30D', bg: '#f8fafc', cardBg: '#ffffff', imgBg: 'linear-gradient(135deg,#ECFCCB,#D9F99D)', border: '#e2e8f0', textColor: '#475569', btnText: '#ffffff', radius: '8px', emoji: '🛍️', sampleDesc: 'Minimaliste', samplePrice: '129 €' },
  ...
  { key: 'wellness', label: 'Wellness', category: 'Minimalist', storeTypes: t('admin.appearanceSettingsForm.templates.options.wellness.storeTypes'), fontName: 'Solway', fontStyle: "'Solway', serif", color: '#84CC16', bg: '#f8fafc', cardBg: '#ffffff', imgBg: 'linear-gradient(135deg,#ECFCCB,#a7f3d0)', border: '#ECFCCB', textColor: '#475569', btnText: '#ffffff', radius: '12px', emoji: '🌿', sampleDesc: 'Bio', samplePrice: '22 €' },
