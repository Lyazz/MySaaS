...
const templates: StoreTemplate[] = [
  ...
  { key: 'playful', category: 'bold', mood: 'light', voice: 'sans', display: "'Baloo 2', 'Nunito', sans-serif", color: '#ED5A96', bg: '#FFF6FA', surface: '#ffffff', border: '#F7D8E7', ink: '#4A2E4D', inkSoft: '#8C6F93', radius: '30px' },
