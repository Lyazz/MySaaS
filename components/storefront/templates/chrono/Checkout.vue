              ...
              >
                <div class="flex items-center gap-4">
                  <div 
                    ...
                    style="border-radius: 2px;"
                  >
                    <CarrierMark :provider="option.provider" :icon="option.icon" :alt="option.providerLabel" class="w-7 h-7 transition-colors duration-300" :class="form.selectedDeliveryOption === option.id ? 'text-[#A67C52]' : 'text-gray-600 group-hover:text-gray-400'" />
                  </div>
