...
<template>
    <div class="animate-fade-in-left">
        <!-- Main Image -->
        <div
          class="aspect-[4/5] bg-slate-50 relative group cursor-zoom-in mb-4 overflow-hidden"
        ...
        <div class="absolute top-4 start-4">
            <span class="bg-white text-slate-900 text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 shadow-sm">
            New Arrival
            </span>
        </div>
        </div>
        ...
        <button 
            ...
            :key="idx"
            class="aspect-square overflow-hidden border transition-all duration-300 relative group"
            :class="activeImageIndex === idx ? 'border-slate-900' : 'border-transparent hover:border-slate-300'"
