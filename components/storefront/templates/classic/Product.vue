...
<template>
  <div class="py-10">
    <div class="max-w-5xl mx-auto px-4">
      <NuxtLink
        to="/products"
        class="text-indigo-600 hover:underline mb-6 inline-flex items-center gap-2"
      >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
          ...
          <button
            ...
            class="mt-6 w-full px-5 py-3 rounded-xl bg-indigo-600 text-white font-medium hover:opacity-90 disabled:bg-slate-300 disabled:cursor-not-allowed transition-opacity"
