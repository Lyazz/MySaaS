...
<div class="text-4xl font-sans font-bold text-brand-600 tracking-tight">
            ...
            <div v-if="(Number(props.product?.price) * 1.2) > 0" class="px-2.5 py-1 bg-slate-900 text-white text-xs font-bold rounded-md shadow-sm tracking-wide whitespace-nowrap shrink-0">
                {{ $t('storefront.product.savePercentage', { percent: 20 }) }}
            </div>
        </div>
