    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
          ...
          >
            <TransitionGroup name="list">
              <li
                ...
                class="flex py-6 sm:py-8 px-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow"
              >
                ...
                <div class="ml-6 rtl:ml-0 rtl:mr-6 flex flex-1 flex-col">
                  ...
                  <div class="flex flex-1 items-end justify-between pt-4">
                    ...
                    <div class="flex items-center space-x-3 rtl:space-x-reverse bg-gray-50 rounded-full px-3 py-1 border border-gray-200">
                      <button
        ...
        <section
          ...
          class="mt-16 bg-white rounded-2xl shadow-lg border border-gray-100 px-6 py-8 sm:p-10 lg:col-span-5 lg:mt-0 lg:sticky lg:top-8"
        >
          <h2
            id="summary-heading"
