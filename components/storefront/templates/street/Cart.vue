  ...
  <div class="min-h-screen bg-gray-50 py-12 px-4">
    <div class="max-w-7xl mx-auto">
      ...
      <div v-if="!cartStore.hasItems" class="text-center py-24 bg-white border-4 border-black shadow-[12px_12px_0_0_#000]">
        ...
        <h2 class="font-street text-4xl mb-6">Empty. Void. Null.</h2>
        <p class="font-mono text-gray-500 mb-8 uppercase">Looks like you haven't added anything yet.</p>
      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <section class="lg:col-span-7">
          <div class="flex items-center justify-between border-b-4 border-black pb-4 mb-8">
            <h2 class="font-street text-3xl uppercase">Items</h2>
            <span class="font-mono text-sm uppercase bg-black text-white px-3 py-1">{{ cartStore.itemCount }} items</span>
          </div>
                ...
                <div class="flex-grow flex flex-col justify-between">
                  <div>
                    ...
                    <p v-if="item.variantId" class="font-mono text-sm text-gray-500 uppercase">
                      Variant: {{ item.variantId.slice(0,6) }}
                    </p>
                  </div>
        ...
        >
          ...
          <dl class="space-y-4 font-mono uppercase mb-8">
            ...
            <div class="flex justify-between">
              ...
              <dd class="text-sm">Calculated at checkout</dd>
            </div>
            <div class="flex justify-between">
