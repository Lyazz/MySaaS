...
<template>
  <div class="bg-white min-h-screen pb-24">
    ...
    <!-- Categories Section -->
    <section v-if="sections.browseByCategory.enabled" class="py-16 md:py-24 bg-white border-b-4 border-black">
      <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16">
          <span class="font-mono text-sm uppercase tracking-widest text-gray-500 mb-3 block">{{ sections.browseByCategory.eyebrow }}</span>
    ...
    <!-- Featured Products -->
    <section v-if="sections.newArrivals.enabled" class="py-16 md:py-24 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <span class="font-mono text-sm uppercase tracking-widest text-gray-500 mb-3 block">{{ sections.newArrivals.eyebrow }}</span>
          <h2 class="text-4xl md:text-5xl font-street text-black uppercase">
    ...
    <!-- Best Sellers -->
    <section v-if="sections.bestSellers.enabled" class="py-16 md:py-24 bg-white border-t-4 border-black">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <span class="font-mono text-sm uppercase tracking-widest text-gray-500 mb-3 block">{{ sections.bestSellers.eyebrow }}</span>
          <h2 class="text-4xl md:text-5xl font-street text-black uppercase">
