          ...
          <div class="h-16 md:h-20 flex items-center justify-between gap-4">
            ...
            <!-- Search Bar (Centered & Rounded) -->
              ...
              <div class="relative group">
                <input 
                  ...
                  class="w-full h-10 bg-white border border-stone-300 text-slate-900 text-sm rounded-sm focus:ring-1 focus:ring-brand-500 focus:border-brand-500 block ps-5 pe-10 transition-all shadow-sm" 
                >
            ...
            <div class="flex items-center gap-6">
              ...
              <div class="flex items-center gap-3">
                ...
                <button
                  class="relative h-10 w-10 flex items-center justify-center text-stone-600 hover:text-brand-700 hover:bg-stone-100 rounded-sm transition-colors"
