...
<template>
  <div class="bg-[#f8faf9] min-h-screen py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="relative overflow-hidden rounded-sm bg-stone-900 text-white mb-8 shadow-sm border border-stone-200">
        <img
        ...
        <div class="relative p-8 sm:p-10 lg:p-12 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <h1 class="text-3xl sm:text-4xl font-bold font-stationery">
              {{ category.title }}
            </h1>
      ...
      <div class="flex flex-col lg:flex-row gap-8">
          ...
          <div>
            ...
            <div class="space-y-2">
              ...
              <NuxtLink 
                ...
                :key="cat.id" 
                :to="`/c/${cat.slug}`"
                class="flex items-center gap-3 cursor-pointer group p-1 rounded-sm hover:bg-stone-100 transition-colors"
        ...
        <div class="flex-1">
          <!-- Header -->
          <div class="bg-white p-6 rounded-sm border border-stone-200 shadow-sm mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h1 class="text-2xl font-stationery font-bold text-slate-900">
                {{ category.title }}
              </h1>
            ...
            <div class="flex items-center gap-3">
              ...
              <select v-model="sortOption" class="rounded-sm border-stone-200 text-sm focus:border-brand-500 focus:ring-brand-500">
