  ...
  <div class="bg-[#fdfbf7] min-h-screen py-8 lg:py-12 font-stationery relative">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex flex-col lg:flex-row gap-10">
        ...
        <aside class="hidden lg:block w-64 flex-shrink-0 space-y-8 bg-white p-6 rounded-sm border border-stone-200 sticky top-24 max-h-[calc(100vh-7rem)] overflow-y-auto pr-2 custom-scrollbar shadow-sm">
          <!-- Filter Header -->
          ...
          <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            ...
            <div class="relative max-w-md w-full">
              <input 
                ...
                class="w-full bg-white border border-stone-300 text-slate-900 text-sm rounded-sm focus:ring-1 focus:ring-brand-500 focus:border-brand-500 block ps-5 pe-10 py-3 shadow-sm transition-shadow hover:shadow-md" 
              >
            ...
            <div class="hidden sm:flex items-center gap-3 w-full sm:w-auto">
              ...
              <div class="relative w-full sm:w-48">
                <select
                  v-model="sortOption"
                  class="w-full appearance-none bg-white rounded-sm border border-stone-300 text-sm py-3 ps-4 pe-10 focus:border-brand-500 focus:ring-brand-500 shadow-sm cursor-pointer hover:border-brand-600 transition-colors text-slate-700 font-medium"
                >
          ...
          <div class="bg-white rounded-sm shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto relative z-10 flex flex-col md:flex-row overflow-hidden border border-stone-200">
              ...
              <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col">
                  ...
                  <div class="mt-auto space-y-4">
                      ...
                      <NuxtLink :to="`/product/${quickViewProduct.slug}`" class="block w-full py-4 border border-stone-300 text-slate-700 font-bold rounded-sm hover:bg-slate-50 transition-colors text-center" @click="closeQuickView">
