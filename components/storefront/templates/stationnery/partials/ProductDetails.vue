...
<template>
  <div class="flex flex-col animate-fade-in-right space-y-8">
    ...
    <div>
      <h1
        class="text-3xl md:text-4xl lg:text-5xl font-stationery font-bold text-slate-900 tracking-tight leading-tight mb-4"
      >
        {{ product?.title }}
      </h1>
      ...
      <div class="flex items-baseline gap-4">
        ...
        />
        <div
          class="text-4xl font-stationery font-bold text-brand-700 tracking-tight"
        >
