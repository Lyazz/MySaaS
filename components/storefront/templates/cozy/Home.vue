...
<template>
  <div class="min-h-screen pb-24">
      ...
      >
        ...
        <div class="absolute inset-0 bg-gradient-to-r from-black/60 via-black/30 to-transparent flex items-center">
          <div class="max-w-7xl mx-auto px-6 w-full">
            ...
            >
              <span class="inline-block px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium mb-4 tracking-wide border border-white/10">Welcome to {{ tenantName }}</span>
    ...
    <!-- Featured Products -->
    <section class="py-12 md:py-16 bg-slate-50/50 rounded-[3rem] mx-4">
