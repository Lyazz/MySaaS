...
<template>
  <div class="synthwave-landing min-h-screen py-6 font-sans pb-24 md:pb-10 overflow-x-hidden w-full relative">
    <!-- Synthwave Background -->
    <div class="fixed inset-0 z-0 pointer-events-none">
      <!-- Gradient background -->
      <div class="absolute inset-0 bg-gradient-to-b from-[#1a0a2e] via-[#16082a] to-[#0d0515]"></div>
      <!-- Sun/horizon glow -->
      <div class="absolute bottom-0 left-1/2 -translate-x-1/2 w-[200%] h-[50%] bg-gradient-to-t from-[#ff2d95]/20 via-[#ff6b35]/10 to-transparent"></div>
      <!-- Grid floor -->
      <div class="absolute bottom-0 left-0 right-0 h-[40%] bg-[linear-gradient(rgba(255,45,149,0.15)_1px,transparent_1px),linear-gradient(90deg,rgba(255,45,149,0.15)_1px,transparent_1px)] bg-[size:40px_40px] [perspective:500px] [transform:rotateX(60deg)] origin-bottom opacity-60"></div>
    </div>
      ...
      <div class="flex flex-col gap-8">
        <div class="lg:grid lg:grid-cols-12 lg:gap-12 items-start">
            ...
            <div class="lg:col-span-7 mb-8 lg:mb-0">
                <div class="relative">
                    <!-- Neon border glow -->
                    <div class="absolute -inset-1 bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500 rounded-2xl blur opacity-30"></div>
            ...
            <div class="lg:col-span-5 flex flex-col gap-8 lg:sticky lg:top-8">
                <div class="relative">
                    <div class="absolute -inset-1 bg-gradient-to-br from-orange-500/30 to-pink-500/30 rounded-2xl blur"></div>
                ...
                <div class="relative">
                    <div class="absolute -inset-1 bg-gradient-to-br from-cyan-500/30 to-pink-500/30 rounded-2xl blur"></div>
