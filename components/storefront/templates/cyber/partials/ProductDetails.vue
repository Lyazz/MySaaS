...
<template>
  <div class="flex flex-col animate-fade-in-right space-y-8">
    ...
    <div>
      <h1
        class="text-3xl md:text-4xl lg:text-5xl font-sans font-bold text-white tracking-tight leading-tight mb-4"
      >
        {{ product?.title }}
      </h1>
      ...
      <div class="flex items-baseline gap-4">
        ...
        />
        <div
          class="text-4xl font-sans font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-orange-400 tracking-tight"
        >
    ...
    >
      <div v-for="option in product.options" :key="option.id">
        <label
          class="block text-sm font-bold text-pink-400 mb-2 uppercase tracking-wider"
          >{{ option.name }}</label
        >
        ...
        >
          ...
          >
            ...
            <span
              v-else
              class="text-xs text-purple-300 flex items-center justify-center w-full h-full bg-purple-900/50"
              >{{ value.label }}</span
            >
            <div
