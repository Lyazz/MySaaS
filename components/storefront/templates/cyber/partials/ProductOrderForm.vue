            ...
            <form class="space-y-5" @submit.prevent="handleOrderSubmit">
                ...
                <div class="space-y-2">
                    ...
                    >
                        ...
                        <option value="16" class="bg-[#1a0a2e]">{{ storefrontContent.algeria.wilayas[16] }}</option>
                        <option value="31" class="bg-[#1a0a2e]">{{ storefrontContent.algeria.wilayas[31] }}</option>
                    </select>
