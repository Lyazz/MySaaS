    ...
    <div class="bg-[#FFFDF9] md:rounded-[28px] p-0 md:p-6 md:shadow-sm md:border border-[#C9A24B]/30 mb-8 lg:mb-0 lg:sticky lg:top-8 animate-fade-in-left">
        ...
        >
            ...
            <div class="absolute top-4 start-4 z-10">
                <span class="bg-white/90 backdrop-blur-md text-[#2E1E20] text-xs font-bold px-3 py-1.5 rounded-full shadow-sm ring-1 ring-[#C9A24B]/30 flex items-center gap-1">
                    <Icon name="lucide:star" class="w-3 h-3 text-[#C9A24B] fill-[#C9A24B]" />
            ...
            <div v-if="images?.length > 1" class="absolute bottom-4 start-0 end-0 flex justify-center gap-2 z-10 md:hidden">
                <button
                    ...
                    :class="activeImageIndex === idx ? 'w-6 bg-white shadow-md' : 'bg-white/50'"
            ...
            <button
                ...
                class="hidden md:flex absolute start-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/85 backdrop-blur-sm rounded-full items-center justify-center text-[#2E1E20] shadow-md opacity-0 group-hover:opacity-100 transition-opacity hover:bg-white z-10"
            >
            ...
            <button
                ...
                class="hidden md:flex absolute end-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/85 backdrop-blur-sm rounded-full items-center justify-center text-[#2E1E20] shadow-md opacity-0 group-hover:opacity-100 transition-opacity hover:bg-white z-10"
            >
        ...
        <div class="grid grid-cols-5 gap-2 md:gap-3">
            <button
                ...
                :class="activeImageIndex === idx ? 'border-brand-500 ring-2 ring-brand-500/15 ring-offset-1' : 'border-transparent ring-1 ring-[#C9A24B]/30 hover:ring-brand-400/60'"
                @click="setActiveImage(idx)"
            >
                <div class="absolute inset-0 bg-[#2E1E20]/0 group-hover:bg-[#2E1E20]/5 transition-colors duration-300" />
                <img
                :src="img"
