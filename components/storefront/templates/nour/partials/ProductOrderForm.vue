  ...
  <div>
    ...
    <div class="flex items-center justify-between p-4 bg-[#FFFDF9] rounded-2xl border border-[#C9A24B]/30 shadow-sm mb-6">
      <div class="flex flex-col gap-0.5">
        ...
        <span
          ...
          class="text-xs font-semibold text-[#6B5850]"
    ...
    >
      ...
      <div class="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 class="font-bold text-[#2E1E20] text-xl leading-none">
      ...
      >
            ...
            <div class="flex items-center gap-4">
              ...
              >
                <CarrierMark
                  ...
                  :class="quickForm.selectedDeliveryOption === option.id ? `text-${option.color}-600` : 'text-[#9C8B82] group-hover:text-[#5C4A44]'"
                />
              </div>
        ...
        <div
          v-else
          class="mt-6 px-4 py-3 border border-dashed border-[#C9A24B]/40 rounded-xl text-center text-xs text-[#9C8B82]"
        >
          <Icon
            name="lucide:map-pin"
            class="w-4 h-4 mx-auto mb-1 text-[#C9A24B]"
          />
    ...
    <div class="mt-8 space-y-4">
      <p class="text-center font-semibold text-[#9C8B82] text-sm mb-4">
    ...
    >
      ...
      >
        <div class="flex flex-col">
          <span class="text-xs text-[#6B5850] font-medium">{{ storefrontContent.cart.summary.total }}</span>
