...
<template>
  <div
    class="bg-[#FAF3EA] min-h-screen py-6 pb-24 md:pb-10 overflow-x-hidden w-full"
  >
    ...
    <div class="w-full mb-8 animate-fade-in-up">
      ...
      <p v-else class="text-[#5C4A44] text-lg leading-relaxed px-4">
    ...
    <div
      v-if="cartEnabled"
      class="fixed bottom-0 left-0 w-full p-4 bg-[#FFFDF9] border-t border-[#C9A24B]/30 md:hidden z-40 flex items-center justify-between shadow-[0_-5px_15px_rgba(46,30,32,0.08)]"
    >
      <div class="flex flex-col">
        <span class="text-xs text-[#6B5850] font-medium">{{
      ...
      <button
        ...
        class="bg-brand-600 text-white px-8 py-3 rounded-2xl font-bold hover:bg-brand-700 transition-colors shadow-md"
      >
