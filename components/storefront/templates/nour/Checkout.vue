...
<template>
  <div class="bg-[#FAF3EA] min-h-screen py-10 text-[#2E1E20]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-[#2E1E20]">
          {{ storefrontContent.checkout.title }}
        </h1>
        <p class="text-lg text-[#6B5850] font-medium">
          {{ storefrontContent.cart.itemsCount(cartStore.itemCount) }}
        </p>
        <div
          v-if="!cartEnabled"
          class="mt-3 rounded-2xl border border-amber-200 bg-amber-50 text-amber-800 text-sm px-4 py-3"
        >
        ...
        <div class="lg:col-span-7 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="col-span-2 md:col-span-1 space-y-2">
                ...
                <input
                  ...
                  type="text"
                  class="w-full h-12 rounded-xl border border-[#C9A24B]/35 bg-[#FFFDF9] px-4 text-[#2E1E20] placeholder:text-[#9C8B82] focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all duration-200 outline-none shadow-sm"
              ...
              <div class="col-span-2 md:col-span-1 space-y-2">
                ...
                <CommuneField
                  ...
                  :input-class="'w-full h-12 rounded-xl border border-[#C9A24B]/35 bg-[#FFFDF9] px-4 text-[#2E1E20] placeholder:text-[#9C8B82] focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all duration-200 outline-none shadow-sm'"
                  :select-class="'w-full h-12 rounded-xl border border-[#C9A24B]/35 bg-[#FFFDF9] px-4 text-[#2E1E20] focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all duration-200 outline-none shadow-sm'"
                />
              </div>
              <div
          ...
          >
            <div class="flex items-center justify-between mb-4">
              ...
              <span class="text-[10px] font-bold text-brand-700 bg-brand-100 px-2 py-1 rounded-full uppercase">
                {{ storefrontContent.checkout.required }}
              </span>
            </div>
            <p class="text-xs text-[#6B5850] mb-6 font-medium">
          ...
          <div class="bg-[#FFFDF9] p-7 rounded-tl-[56px] rounded-tr-2xl rounded-br-2xl rounded-bl-2xl shadow-md border border-[#C9A24B]/30 sticky top-24">
            ...
            <div class="space-y-4 mb-6 max-h-80 overflow-y-auto pe-2">
              <div
                ...
                :key="item.productId"
                class="flex items-center gap-4 py-2 border-b border-[#C9A24B]/15 last:border-0"
              >
                <div class="h-16 w-16 bg-[#F3E7D8] rounded-xl flex-shrink-0 overflow-hidden relative border border-[#C9A24B]/25">
                  <img
                    v-if="item.image"
                    :src="item.image"
                    :alt="item.title"
                ...
                <div class="flex-1 min-w-0">
                  <h4 class="font-bold text-[#2E1E20] text-sm truncate">
                    {{ item.title }}
                  </h4>
                  <p class="text-xs text-[#6B5850] mt-1">
                    x{{ item.quantity }}
                  </p>
                </div>
                <div class="font-bold text-brand-700 text-sm whitespace-nowrap">
            ...
            <div class="bg-brand-50/40 p-5 rounded-2xl border border-[#C9A24B]/30 mb-6">
              <div class="flex justify-between items-center mb-3">
                ...
                <span class="text-[10px] font-bold text-brand-700 bg-[#C9A24B]/25 px-2.5 py-1 rounded-full uppercase tracking-wide">
              ...
              <div class="flex gap-2">
                <input
                  ...
                  class="flex-1 h-11 rounded-xl border-2 border-[#C9A24B]/30 bg-[#FFFDF9] px-4 text-sm text-[#2E1E20] placeholder:text-[#9C8B82] focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all duration-200 outline-none shadow-sm font-medium"
                >
                <button
                  type="button"
                  class="px-5 h-11 bg-brand-600 hover:bg-brand-700 text-white font-bold text-sm rounded-xl transition-all duration-200 hover:shadow-md whitespace-nowrap"
            ...
            <div class="space-y-3 pt-4 border-t border-[#C9A24B]/25">
              ...
              <div
                ...
                class="flex justify-between text-sm"
              >
                <span class="text-amber-700">{{ promoDiscountLabel }}</span>
              ...
              <div class="flex justify-between items-end pt-4 border-t border-[#C9A24B]/25 mt-4">
                <span class="font-bold text-xl text-[#2E1E20]">{{ storefrontContent.cart.summary.total }}</span>
                <span class="font-bold text-xl text-[#2E1E20]">{{ formatAmount(grandTotal) }} {{ currencyCode }}</span>
              </div>
              <p class="text-xs text-[#9C8B82] mt-1">
            ...
            <button
              ...
              class="w-full mt-6 bg-brand-700 hover:bg-brand-800 text-white font-bold py-4 px-6 rounded-2xl shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 flex items-center justify-center gap-2.5 group relative overflow-hidden"
              @click="handleSubmit"
            >
