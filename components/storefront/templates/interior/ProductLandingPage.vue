...
<template>
  <div class="bg-slate-50 min-h-screen py-6 font-sans pb-24 md:pb-10 overflow-x-hidden w-full">
    ...
    >
      <div class="flex flex-col">
        <span class="text-xs text-slate-500 font-medium">{{ storefrontContent.productForm.totalPrice }}</span>
