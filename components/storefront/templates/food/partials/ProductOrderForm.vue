    ...
    <div>
        ...
        >
            ...
            <form class="space-y-5" @submit.prevent="handleOrderSubmit">
                <div class="space-y-2">
                <label class="block text-sm font-semibold text-stone-700 ms-1">{{ storefrontContent.checkout.form.fullName.label }}</label>
                <input 
                ...
                <div class="space-y-2">
                <label class="block text-sm font-semibold text-stone-700 ms-1">{{ storefrontContent.checkout.form.phone.label }}</label>
                <input
                ...
                <div class="space-y-2">
                    <label class="block text-sm font-semibold text-stone-700 ms-1">{{ storefrontContent.checkout.form.wilaya.label }}</label>
                    <WilayaField
                ...
                <div class="space-y-2">
                    <label class="block text-sm font-semibold text-stone-700 ms-1">{{ storefrontContent.checkout.form.commune.label }}</label>
                    <CommuneField
                ...
                <div v-if="!hideOptionalAddress" class="space-y-2">
                    <label class="block text-sm font-semibold text-stone-700 ms-1">{{ storefrontContent.checkout.form.address.label }}</label>
                    <input
