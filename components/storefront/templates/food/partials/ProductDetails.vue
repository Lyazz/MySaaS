...
<template>
    <div class="flex flex-col animate-fade-in-right space-y-8">
        <!-- Header -->
        <div>
        <h1 class="text-3xl md:text-4xl lg:text-5xl font-sans font-bold text-stone-900 tracking-tight leading-tight mb-4">
            {{ product?.title }}
        </h1>
        ...
        <div
            ...
            :key="option.id"
        >
            <label class="block text-sm font-medium text-stone-700 mb-2">{{ option.name }}</label>
