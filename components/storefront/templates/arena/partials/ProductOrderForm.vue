  ...
  <div>
    ...
    >
      ...
      >
            ...
            <div class="flex items-center gap-4">
              ...
              >
                <CarrierMark
                  ...
                  :class="quickForm.selectedDeliveryOption === option.id ? `text-${option.color}-600` : 'text-slate-400 group-hover:text-slate-400'"
                />
              </div>
        ...
        <div
          v-else
          class="mt-6 px-4 py-3 border border-dashed border-white/10 text-center text-xs text-slate-400"
        >
          <Icon
            name="lucide:map-pin"
        ...
        <div class="bg-[#06080c] rounded-xl border border-white/[0.06] p-4 space-y-3">
          <div class="flex items-center justify-between text-sm">
            ...
            <span class="font-bold text-slate-200">{{ formatAmount(rawSubtotal) }} {{ currencyCode }}</span>
          </div>
          ...
          >
            <span class="text-amber-500">{{ t('storefront.clearance.discountLine') }}</span>
            <span class="font-bold text-amber-500">-{{ formatAmount(quickOrderClearanceDiscount) }} {{ currencyCode }}</span>
          </div>
