    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-7 space-y-8">
          ...
          <!-- Delivery Options -->
          <div v-if="form.wilaya && form.commune" class="bg-white p-6 rounded-[2rem] border-4 border-purple-100">
                ...
                <div class="flex items-center gap-4">
                  ...
                  <div class="flex items-center gap-3 flex-shrink-0">
                    ...
                    >
                      ...
                      >
                        <Icon name="lucide:check" class="w-3 h-3 text-white stroke-[4]" />
                      </span>
                    </span>
                  </div>
                </div>
          ...
          <div v-else class="bg-white p-6 rounded-[2rem] border-4 border-purple-100 text-center text-sm text-slate-400">
