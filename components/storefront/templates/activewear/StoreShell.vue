            ...
            <div class="flex items-center gap-6">
              ...
              <nav class="hidden lg:flex items-center gap-6">
                <NuxtLink 
                  ...
                  :key="item.name" 
                  :to="item.href"
                  class="text-xl font-bold text-slate-300 uppercase italic tracking-wide hover:text-brand-500 hover:skew-x-[-10deg] transition-all"
                  active-class="text-brand-500 skew-x-[-10deg]"
                >
                  {{ item.name }}
                </NuxtLink>
              </nav>
              ...
              <div class="flex items-center gap-3">
                ...
                >
                  <Icon name="lucide:user" class="w-5 h-5 skew-x-[10deg]" />
                </button>
