...
<template>
  <div class="min-h-screen bg-wl-paper py-12 md:py-16 font-wellness text-wl-ink">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div
        v-if="submitting"
        class="fixed inset-0 bg-wl-paper/90 backdrop-blur-sm z-50 flex flex-col items-center justify-center"
      >
        <div class="w-10 h-10 border border-wl-rule border-t-wl-ink rounded-full animate-spin mb-5" />
        ...
        <section class="lg:col-span-7 space-y-8">
          ...
          >
            ...
            <div
              ...
              class="bg-wl-card border border-wl-rule p-6 sm:p-8"
            >
              <h2 class="wl-label text-wl-ink mb-6 flex items-center gap-3 pb-4 border-b border-wl-rule">
            ...
            <div
              v-else
              class="bg-wl-card border border-wl-rule p-8 text-center text-sm text-wl-muted"
            >
              <Icon
                name="lucide:map-pin"
                class="w-5 h-5 mx-auto mb-3 text-wl-muted"
              />
            ...
            >
              <Icon
                ...
                class="w-4 h-4 text-wl-alert flex-shrink-0 mt-0.5"
              />
        ...
        <section class="mt-12 bg-wl-card border border-wl-rule px-6 sm:px-7 py-7 lg:col-span-5 lg:mt-0 lg:sticky lg:top-24">
          ...
          >
            <li
              ...
              :key="item.variantId"
              class="flex py-4 border-b border-wl-rule/60 last:border-0"
            >
              ...
              <div class="ms-4 flex flex-1 flex-col min-w-0">
                <div>
                  <div class="flex justify-between gap-3 text-wl-ink">
                    <h3 class="wl-display-sm text-sm line-clamp-1">
                      {{ item.title }}
                    </h3>
                    <p class="wl-num text-sm flex-shrink-0">
                      {{ formatCurrency(item.price) }}
                    </p>
                  </div>
                  <p class="mt-1 wl-label text-wl-muted">
                    {{ item.variantName || storefrontContent.cart.item.standardItem }}
                  </p>
                </div>
                <div class="flex flex-1 items-end justify-between">
                  <p class="wl-label wl-num text-wl-muted">
          ...
          <div class="border-t border-wl-rule pt-5 mb-5">
            <div class="flex items-center gap-2 mb-2.5">
              <Icon
                name="lucide:ticket"
                class="w-3.5 h-3.5 text-wl-muted"
              />
            ...
            <div class="flex">
              ...
              <button
                type="button"
                class="wl-cta px-5 h-11 wl-label flex-shrink-0"
          ...
          <div class="border-t border-wl-rule pt-5 space-y-3.5">
            <div class="flex items-center justify-between gap-4 text-sm">
              <dt class="text-wl-muted">
                {{ storefrontContent.cart.summary.subtotal }}
              </dt>
              <dd class="wl-num font-medium text-wl-ink">
            ...
            >
              <dt class="text-wl-henna font-medium">
                {{ t('storefront.clearance.discountLine') }}
              </dt>
              <dd class="wl-num font-medium text-wl-henna">
            ...
            >
              ...
              <dd class="wl-num font-medium text-wl-henna">
                -{{ formatCurrency(promoTotalDiscount) }}
              </dd>
            </div>
            <div
            ...
            >
              ...
              <dd class="wl-num font-medium text-wl-ink flex-shrink-0">
