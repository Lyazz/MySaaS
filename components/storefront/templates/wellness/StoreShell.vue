               ...
               <div class="relative group hidden lg:flex items-center">
                  ...
                  >
                    ...
                    <div v-else class="flex flex-col gap-1">
                      ...
                      >
                        <img v-if="product.images && product.images.length > 0" :src="product.images[0]" class="w-10 h-10 object-cover rounded-[1rem] shadow-sm" />
                        <div v-else class="w-10 h-10 bg-stone-100 rounded-[1rem] flex items-center justify-center">
