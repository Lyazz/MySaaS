...
const handleOrderSubmit = async () => {
  ...
  // If COD is enabled, validate form (simple check)
  ...
  <div class="bg-slate-50 min-h-screen pb-20 font-sans">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 py-6">
      ...
      <div class="lg:grid lg:grid-cols-12 lg:gap-12 items-start">
        ...
        <div
          class="lg:col-span-8 bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 mb-10 lg:mb-0 animate-fade-in-up"
        ...
        <div class="lg:col-span-4 lg:sticky lg:top-8 order-2">
                <div
                  ...
                  class="bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-brand-100 relative overflow-hidden animate-fade-in-up"
                  style="animation-delay: 0.2s"
                >
            <!-- Decorative Top Bar -->
            <div class="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-brand-500 to-brand-700" />
            ...
            >
                ...
                <div class="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      class="block w-full h-12 rounded-xl border-slate-200 bg-slate-50 px-4 focus:ring-brand-500 focus:border-brand-500"
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="pt-4">
                ...
                <div
                  v-else-if="cartEnabled"
                  class="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-slate-200 text-center text-slate-600"
                >
                    <button 
                        type="button"
                        :disabled="isAdding"
    ...
    >
      <div
        v-if="showSuccess"
        class="fixed bottom-24 md:bottom-10 right-4 z-50 bg-slate-900 text-white px-6 py-4 rounded-2xl shadow-xl flex items-center gap-4"
      >
