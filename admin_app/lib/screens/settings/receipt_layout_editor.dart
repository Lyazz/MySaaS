...
final _kPresets = [
  _PresetTemplate(
    key: 'minimal',
    label: 'Minimal',
    description: 'Store name, items & total only',
  ...
  _PresetTemplate(
    key: 'full',
    label: 'Full Detail',
    description: 'Everything — logo, contacts, tax, footer',
  ...
  _PresetTemplate(
    key: 'arabic',
    label: 'Arabic',
    description: 'RTL-safe, no logo, clean layout',
  ...
  _PresetTemplate(
    key: 'kitchen',
    label: 'Quick Print',
    description: 'Items only — kitchen ticket style',
      ...
      actions: [
        Padding(
          ...
          child: AppButton.primary(
            label: 'admin.receipt.editor.saveLayout'.tr(),
  ...
  Widget _buildStoreInfoSection(ReceiptLayout layout) {
    return _EditorCard(
      child: Column(
        children: [
          _PillToggleRow(
            label: 'admin.receipt.editor.showLogo'.tr(),
          ...
          const _Divider(),
          _PillToggleRow(
            label: 'admin.receipt.editor.showStoreName'.tr(),
          ...
          _ExpandingField(
            ...
            child: FormInput(
              label: 'admin.receipt.editor.storeNameOverride'.tr(),
              controller: _storeNameController,
            ),
          ),
          const _Divider(),
          _PillToggleRow(
            label: 'admin.receipt.editor.showStoreAddress'.tr(),
          ...
          _ExpandingField(
            ...
            child: FormInput(
              label: 'admin.receipt.editor.storeAddressOverride'.tr(),
              controller: _storeAddressController,
            ),
          ),
          const _Divider(),
          _PillToggleRow(
            label: 'admin.receipt.editor.showStorePhone'.tr(),
          ...
          _ExpandingField(
            ...
            child: FormInput(
              label: 'admin.receipt.editor.storePhoneOverride'.tr(),
              controller: _storePhoneController,
            ),
          ),
          const _Divider(),
          _PillToggleRow(
            label: 'admin.receipt.editor.showStoreEmail'.tr(),
          ...
          _ExpandingField(
            ...
            child: FormInput(
              label: 'admin.receipt.editor.storeEmailOverride'.tr(),
  ...
  Widget _buildHeaderSection(ReceiptLayout layout) {
    return _EditorCard(
      child: Column(
        children: [
          _PillToggleRow(
            label: 'admin.receipt.editor.showCustomHeader'.tr(),
          ...
          _ExpandingField(
            ...
            child: FormInput(
              label: 'admin.receipt.editor.headerText'.tr(),
  ...
  Widget _buildContentSection(ReceiptLayout layout) {
    return _EditorCard(
      child: Column(
        children: [
          _PillToggleRow(
            label: 'admin.receipt.editor.showOrderNumber'.tr(),
          ...
          const _Divider(),
          _PillToggleRow(
            label: 'admin.receipt.editor.showDate'.tr(),
          ...
          const _Divider(),
          _PillToggleRow(
            label: 'admin.receipt.editor.showCustomerInfo'.tr(),
          ...
          const _Divider(),
          _PillToggleRow(
            label: 'admin.receipt.editor.showTaxBreakdown'.tr(),
  ...
  Widget _buildFooterSection(ReceiptLayout layout) {
    return _EditorCard(
      child: Column(
        children: [
          _PillToggleRow(
            label: 'admin.receipt.editor.showFooterMessage'.tr(),
          ...
          _ExpandingField(
            ...
            child: FormInput(
              label: 'admin.receipt.editor.footerText'.tr(),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              Text(
                'Receipt updates instantly as you edit',
                style: TextStyle(
                    fontSize: 12,
