...
void main() {
  // Create a helper widget for SettingsSection and SettingsPageHeader to be reused.
  final sectionCode = """
...
""";
  ...
  File('admin_app/lib/widgets/settings/settings_section.dart')
    ..createSync(recursive: true)
    ..writeAsStringSync(sectionCode);
}
